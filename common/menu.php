...
if(isset($_POST['sign-up']))
{
    ...
    $i_sql_edit = "SELECT * FROM student where username = '".$_POST['username']."' ";
    ...
    if($status)
    {
        ...
        if(isset($_FILES["choose-file"]["name"]))
        {
    ...
    // if everything is ok, try to upload file
      ...
      if (move_uploaded_file($_FILES["choose-file"]["tmp_name"], $target_dir . $newfilename)) {
        ...
        echo "Sorry, there was an error uploading your file.";
            ...
            $sql = "INSERT INTO `student`(`firstname`, `midle`, `lastname`, `class`, `age`, `username`, `password`, `company`) VALUES ('".$_POST['firstname']."', '-', '".$_POST['lastname']."', '".$_POST['category']."', '".$_POST['age']."','".$_POST['username']."', '".$_POST['password']."','-')";
			  	...
			  	<div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      	<ul class="nav navbar-nav mu-menu navbar-right">
					        ...
					        <li><a href="index.php#mu-book-overview">OVERVIEW</a></li>
					        <li><a href="index.php#mu-video-review">VIDEO's</a></li>
				            ...
				            if(!$user)
				            {
				                ...
				                echo '<li data-toggle="modal" data-target="#user-profile" style="border: 1px solid white; border-radius: 5px;"> <a href="profile.php">Welcome :'.$user.'</a></li>';
				            }
				            ?>
				      	</ul>
				    </div><!-- /.navbar-collapse -->
    ...
    <div class="modal-content" style="margin-top: 100px;background-color: rgba(0,0,0,0.9); ">
      ...
      <div class="modal-footer">
          <div style="width: 100%;text-align: center;color: white;">
                ...
                <br> <a style="color: white;cursor: pointer;text-decoration:underline " data-toggle="modal" data-dismiss="modal" data-target="#user-forgot">Forgot Password</a>.
      </div>
...
<!-- For got -->
<div class="modal" id="user-forgot" >
  <div class="modal-dialog" style="width: 550px; border-radius: 10px;">
    ...
    <div class="modal-content" style="margin-top: 100px;background-color: rgba(0,0,0,0.9); ">
      ...
      <div class="modal-body">
          ...
          <div class="input-group" style="padding: 10px 0px; color: white;width: 100%">
              <p>Enter the Email ID with which you are registered on e-Learning.com</p>
            <!--<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>-->
            <input id="username" type="text" class="form-control" style="background-color: rgba(0,0,0,0.5);color: white;padding: 10px;width: 100%" name="username" >
            <br>
            <br>
          ...
          <div class="row">
              <div class="col-lg-6">
                  <button type="submit" class="btn btn-success" style="width:100%" name="forgot">Submit</button>
              </div>
              <div class="col-lg-6">
                  <button type="button" class="btn btn-danger" style="width:100%" data-dismiss="modal">Close</button>
              </div>
      ...
      <div class="modal-body">
        <div class="row">
              <div class="col-lg-4 text-center">
                <div id="img-preview"><img src='assets/images/user.png'></div>
