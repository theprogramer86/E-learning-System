...
if(isset($_POST['last']))
{
    ...
    while($row = $last_r->fetch_assoc()) {
        ...
        // $str = '"{\"iname\":\"'.$row["iname"].'\",\"price\":\"'.$row["price"].'\",\"qty\":'.$row["quan"].'}"';
        // $aa = array("iname"=> $row['iname'], "price"=> $row['price'], , "qty"=> $row['quan']);
        array_push($cart_temp, $myJSON);
    }
    
    // $data = json_encode($cart_temp);
    // print_r($data);
    // $_SESSION['cart'] = "hello";
    // setcookie("itemsquantity", $itemsquantity, time() + 3600, '/');
    // setcookie("Cart", $cart_temp, time() + 3600, '/');
    // echo "<script>window.alert('Last Submitted!');</script>";
    } else {
        $last_bill = $new_bill;
        $pby = "";
        $remark = "";
...
if(isset($_POST['next']))
{
    // echo "<script>window.alert('Next Submitted!');</script>";
    $last_bill = $_POST['billno'] + 1;
...
<body style="background: #d7dbd8;overflow-x: hidden">
...
<div class="col-lg-12" style="padding: 10px 20px">
    <div class="row">
        <div class="col-lg-1" >
            <b>Bill No</b>: <?php echo $last_bill; ?>
        </div>
        <div class="col-lg-9" >
            <div style="display: flex;width:100%">
                <div><b>Date</b> :</div>
                <div style="padding-left:5px"> <?php echo date("d-m-Y"); ?></div>
                <div  id="MyClockDisplay" style="padding-left:5px" onload="showTime()"></div>
            </div>
        </div>
        <div class="col-lg-2">
            <button title="Calculator" id="btnCalculator" type="button" class="btn btn-success btn-flat pull-right popover-default" 
                data-toggle="modal" data-target="#myModal" data-html="true" data-placement="bottom">
...
<div class="col-sm-6">
    <div class="card" style="width: 100%; height: 80vh; overflow-y: scroll; padding: 20px">
        <div class="cart-container">
           ...
           <hr>
           <table id="carttotals" style="width: 100%">
             <tr>
...
<div class="col-sm-6">
     <div style="width: 100%; height: 80vh; overflow-y: scroll; padding: 20px">
    <div class="row">
	           <?php
