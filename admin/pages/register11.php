...
<body  class="full-body">
    ...
    <div class="row">
            <div class="col-lg-6 left-box">
                <img src="img/Analyze-rafiki.svg" width="80%">
            </div>
            <div class="col-lg-6" style="background-color: white">
                ...
                <!-- Nested Row within Card Body -->
                        <!--<div class="p-5">-->
                            ...
                            <form id="regForm" action="" style="margin-top: -15px !important">
                              ...
                              <div class="tab">
                                ...
                                <div class="form-group">
                                    Bussiness Name:<br>
                                    <input type="text" class="form-control form-control-user" placeholder=" " oninput="this.className = ''" name="bname" onkeyup="checkCompany(this.value)">
                                    <div id="company"></div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input list="browsers" class="form-control form-control-user" id="browser" type="text"  id="exampleLastName"
                                            placeholder=" " oninput="this.className = ''" name="currency">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Email:<br>
                                        <input type="text" class="form-control form-control-user" placeholder=" "  id="exampleFirstName"
                                 ...
                                 <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user"  id="exampleFirstName"
                                            placeholder=" " oninput="this.className = ''" name="mobile">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                              ...
                              <div class="tab">
                                ...
                                <div class="form-group">
                                    Owner Name:<br>
                                    <input type="text" class="form-control form-control-user" placeholder=" " oninput="this.className = ''" name="oname">
                                </div>
                                <div class="form-group">
                                    Address:<br>
                                    <input type="text" class="form-control form-control-user" placeholder=" " oninput="this.className = ''" name="add1">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" placeholder=" " oninput="this.className = ''" name="add2">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" placeholder=" " oninput="this.className = ''" name="add3">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Account Approval:<br>
                                        <input type="text" class="form-control form-control-user"  id="exampleFirstName"
                                            placeholder=" " oninput="this.className = ''" name="acount_apporval">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Plan:<br>
                                        <input type="text" class="form-control form-control-user"  
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Amount:<br>
                                        <input type="text" class="form-control form-control-user"  id="exampleFirstName"
                                            placeholder=" " oninput="this.className = ''" name="amount">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Monthly:<br>
                                        <input type="text" class="form-control form-control-user"  
                                            placeholder=" " name="monthly">
                                    </div>
                                </div>
                              </div>
                              <div class="tab">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        License Status:<br>
                                        <input type="text" class="form-control form-control-user"  id="exampleFirstName"
                                            placeholder=" " oninput="this.className = ''" name="license_status">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Paymode:<br>
                                        <select type="date" class="form-control form-control-user"  
                                            placeholder=" " name="pby">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="date" class="form-control form-control-user"  
                                            placeholder=" " name="edate">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Ldays:<br>
                                        <input type="text" class="form-control form-control-user"  id="exampleFirstName"
                                            placeholder=" " oninput="this.className = ''" name="ldate">
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Tax No:<br>
                                        <input type="text" class="form-control form-control-user"  
                                            placeholder=" " name="txn_no">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Remark:<br>
                                        <input type="text" class="form-control form-control-user"  id="exampleFirstName"
                                            placeholder=" " oninput="this.className = ''" name="remarks">
                                    </div>
                              ...
                              <div class="tab">
                                  <h5>Login Info</h5>:
                                    <div class="form-group">
                                        Admin User:<br>
                                        <input type="text" class="form-control form-control-user" placeholder=" " oninput="this.className = ''" name="username" onkeyup="checkUser(this.value)">
                                        <div id="user"></div>
                                    </div>
                                    <div class="form-group">
                                        Password :<br>
                                        <input type="password" class="form-control form-control-user" placeholder=" " oninput="this.className = ''" name="password">
                                    </div>
                              </div>
                            ...
                            <div class="text-center" style="margin-top: 10px">
                                            Already have an account? <a class="small" href="login.php" style="font-size: 14px;font-weight: 600;text-decoration: none">Sign in</a>
                            </div>
                        <!--</div>-->
                </div>
