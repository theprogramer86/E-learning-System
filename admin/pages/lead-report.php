...
{
    $i_sql = "SELECT * FROM lead_entry WHERE user='".$_SESSION["Username"]."' ORDER BY fdate";
    $i_result = $conn->query($i_sql);
    while($row = $i_result->fetch_assoc()) {
        array_push($leads,$row);
    }
} else {
    $i_sql = "SELECT * FROM lead_entry ORDER BY fdate";
    $i_result = $conn->query($i_sql);
    while($row = $i_result->fetch_assoc()) {
        array_push($leads,$row);
    }
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Lead Report</h6>
