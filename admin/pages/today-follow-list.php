...
{
    $i_sql = "SELECT * FROM lead_entry WHERE fdate='".date('Y-m-d')."' and user='".$_SESSION["Username"]."' ORDER BY sno DESC";
    $i_result = $conn->query($i_sql);
    while($row = $i_result->fetch_assoc()) {
        array_push($leads,$row);
    }
} else {
    $i_sql = "SELECT * FROM lead_entry WHERE fdate='".date('Y-m-d')."' ORDER BY sno DESC";
    $i_result = $conn->query($i_sql);
    while($row = $i_result->fetch_assoc()) {
        array_push($leads,$row);
    }
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Today Followup's</h6>
                            ...
                            <form action="" method="POST">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                                ...
                                                <div class="col-xl-8 col-lg-8" style="padding: 10px 10px">
                                                    ...
                                                    <select class="form-control" name="status" id="sel1" value="<?php echo $lead['status']; ?>">
                                                        <option value="<?php echo $lead['status']; ?>"><?php echo $lead['status']; ?></option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-lg-8">
                                        <input type="text" name="remark" class="input-box" id="usr" value="<?php echo $lead['remarks']; ?>">
                                    </div>
                                </div>
                              </div>
