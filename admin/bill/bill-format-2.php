...
<body>
    ...
    <div style="width: 100%;padding: 20px;">
        <div class="content" style="background-color: white; margin-bottom: 20px;">
            ...
            <!--    <div style="width: 10%;padding: 5px 15px">-->
            <!--        <p>Image</p>-->
            <!--    </div>-->
            ...
            {
                ?>
                <div style="display: block;width: 100%;border-bottom: 2px solid white;">
                    
                    <div style="width: 100%;padding: 5px 15px">
                        <?php echo $data['iname']; ?> <br>
                        <?php echo $setting['curency']?$setting['curency']:''; ?> <?php echo $data['quan']*$data['amount']; ?> /-
                    </div>
                    <div style="width: 100%;padding: 5px 15px;text-align: center">
                        <?php 
                        $img = $conn->query("SELECT * FROM item where iname='".$data['iname']."' and company = '".$company."' ")->fetch_assoc();
                        
                        echo "<img src='http://koolpos.eshop.life/".$img['photo']."' height='80px' width='80px' >"; 
